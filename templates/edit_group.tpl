				...
				{jstab title="Group Information"}
					{legend legend="Group Information"}
						...
						<div class="form-group submit">
							...
							<input type="submit" class="btn btn-default" name="save_group" value="{tr}Save{/tr}" />&nbsp;
							<input type="submit" class="btn btn-default" name="save_group_continue" value="{tr}Save and Continue Editing{/tr}" />
						</div>
					{/legend}
				{/jstab}
