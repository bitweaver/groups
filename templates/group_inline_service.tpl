...
<div class="group-permalink">
	...
	{/foreach}
{/if}
{if is_object($gContent) && $gContent->hasUserPermission('p_groups_view') && $gContent->hasEditPermission() && (!$gBitSystem->isFeatureActive('group_admin_content') || (isset($contentMemberGroups) && count($contentMemberGroups)==0))}
